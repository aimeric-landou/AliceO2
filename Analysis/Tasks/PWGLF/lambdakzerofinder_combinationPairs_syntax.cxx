...
struct lambdakzeroprefilter_combinations {
...
struct lambdakzerofinder_combinations {
               ...
               aod::V0GoodPosTracks const& ptracks, aod::V0GoodNegTracks const& ntracks)
  {
    ...
    for (auto& [t0id, t1id] : combinations(ptracks, ntracks)) {
...
struct lambdakzerofinderQA_combinations {
  //Basic checks
  //Selection criteria
...
struct lambdakzeroinitializer_combinations {
...
{
  return WorkflowSpec{
    adaptAnalysisTask<lambdakzeroprefilter_combinations>(cfgc, TaskName{"lf-lambdakzeroprefilter-combinations"}),
    adaptAnalysisTask<lambdakzerofinder_combinations>(cfgc, TaskName{"lf-lambdakzerofinder-combinations"}),
    adaptAnalysisTask<lambdakzerofinderQA_combinations>(cfgc, TaskName{"lf-lambdakzerofinderQA-combinations"}),
    adaptAnalysisTask<lambdakzeroinitializer_combinations>(cfgc, TaskName{"lf-lambdakzeroinitializer-combinations"})};
}

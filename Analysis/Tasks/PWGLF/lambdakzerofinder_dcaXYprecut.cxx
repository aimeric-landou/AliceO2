...
struct lambdakzeroprefilter_dcaXYprecut {
...
struct lambdakzerofinder_dcaXYprecut {
  ...
  Configurable<float> maxdxy{"maxdxy",4.0,"maxdxy"};
...
struct lambdakzerofinderQA_dcaXYprecut {
  //Basic checks
  //Selection criteria
...
struct lambdakzeroinitializer_dcaXYprecut {
...
{
  return WorkflowSpec{
    adaptAnalysisTask<lambdakzeroprefilter_dcaXYprecut>(cfgc, TaskName{"lf-lambdakzeroprefilter-dcaXYprecut"}),
    adaptAnalysisTask<lambdakzerofinder_dcaXYprecut>(cfgc, TaskName{"lf-lambdakzerofinder-dcaXYprecut"}),
    adaptAnalysisTask<lambdakzerofinderQA_dcaXYprecut>(cfgc, TaskName{"lf-lambdakzerofinderQA-dcaXYprecut"}),
    adaptAnalysisTask<lambdakzeroinitializer_dcaXYprecut>(cfgc, TaskName{"lf-lambdakzeroinitializer-dcaXYprecut"})};
}
